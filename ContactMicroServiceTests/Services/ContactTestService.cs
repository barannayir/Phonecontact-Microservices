...
using ContactMicroService.Mappers;
...
namespace ContactMicroServiceTests.Services
{
    public class ContactTestService : IContactRepository
    {
        private readonly List<ContactModel> contextDb;
        private readonly IMapper _mapper;
        public ContactTestService()
        {
        ...
        public async Task<Response<List<ContactStatisticsDto>>> GetAllContactWithCommunicationsAsync()
        {
            ...
            CommunicationTestService communicationTestService = new CommunicationTestService();
            var communications = (await communicationTestService.GetAllByContactIdsAsync(contactIds)).Data;
        ...
        public async Task<Response<ContactWithCommunicationsDto>> GetById(string id)
        {
            ...
            CommunicationTestService communicationTestService = new CommunicationTestService();
            var communicationsResponse = await communicationTestService.GetAllByContactIdAsync(contact.Id);
